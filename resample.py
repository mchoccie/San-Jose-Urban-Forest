...
parser = argparse.ArgumentParser(prog='Tile Resampler')
...
this_dir =  os.getcwd()
tile_folder = args.source
output_folder = args.destination

source_map_tile_xyz_pattern = tile_folder + '/{z}/{x}/{y}.png'
source_map_tile_zoom= 18
dataset_area_bbox=      [-13586544, 4455846, -13534223, 4504823]
dataset_img_width=      1312
dataset_img_height=     1312
dataset_img_overlapping= 96
dataset_img_dir = this_dir + '/' +output_folder + '/output'
dataset_img_meta_path = this_dir +'/'+ output_folder +'/meta'


# source: https://github.com/easz/urban-tree/blob/main/urbantree/preprocessing.py
def dataset_resample_xyz_tiles(source_map_tile_xyz_pattern,
 ...
 """
  ...
  TOTAL = math.ceil((SOURCE_MAP_TILE_WIDTH_PX * (BOTTOM_RIGHT_TILE.x - UPPER_LEFT_TILE.x + 1) - DATASET_IMG_OVERLAPPING_PX) / (DATASET_IMG_WIDTH_PX - DATASET_IMG_OVERLAPPING_PX))         * math.ceil((SOURCE_MAP_TILE_HEIGHT_PX * (BOTTOM_RIGHT_TILE.y - UPPER_LEFT_TILE.y + 1) - DATASET_IMG_OVERLAPPING_PX) / (DATASET_IMG_HEIGHT_PX - DATASET_IMG_OVERLAPPING_PX))
...
dataset_resample_xyz_tiles(source_map_tile_xyz_pattern,
                               source_map_tile_zoom,
                               dataset_area_bbox,
                               dataset_img_dir,
